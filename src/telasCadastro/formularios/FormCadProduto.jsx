...
export default function FormCadprodutos(props) {
    ...
    function manipularSubmissao(e){
        ...
        if (form.checkValidity()){
            if(!props.modoEdicao){
                props.setListaProdutos([...props.listaProduto,produto]);
                props.setMensagem('Produto cadastrado com sucesso');
                props.setTipoMensagem('success');
                props.setMostrarMensagem(true);
            }
            else{
                props.setListaProdutos([...props.listaProduto.filter((itemproduto)=>itemproduto.nomeprod !== produto.nomeprod),produto]);
    ...
    return (
        <Container>
            <Form noValidate validated={formValidado} onSubmit={manipularSubmissao}>
                ...
                <Row>
                    <Col>
                        <FloatingLabel controlId="floatingSelect" label="País de Origem:">
                            <Form.Select 
                                id='country'
                                name='country'
                                onChange={manipularMudancas}
                                value={produto.country}>
